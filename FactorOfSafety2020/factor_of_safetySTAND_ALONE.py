...
try:
        print('Running factor of safety using Infinite Slope per Hammond et al. (1992)')
        import arcpy
        from arcpy.sa import *
        import traceback
        import sys
        
        # Check out  necessary licenses. This tool requires a spatial analyst and 3d analyst extention from ESRI.
        ...
        def FactorSafety(surface_slope_raster_in_degrees, total_soil_thickness_raster, Dw_D_ratio, moist_soil_unit_weight, dry_soil_unit_weight, saturated_soil_unit_weight, water_unit_weight, vegetation_surcharge, tree_root_strength_as_cohesion, soil_cohesion, effective_internal_angle_of_friction, factor_of_safety):  
                ...
                print('Calculating the resisting force raster...')
                ...
                print('Calculating the driving force raster...')
                ...
                print('Calculating the factor of safety')
